...
import { Network, NetworkType } from '../common/types';
...
export const NetworkIDToHRP:{[key: number]:string} = {
  0: 'custom',
  1: 'avax',
  2: 'cascade',
  3: 'denali',
...
export const NetworkIDToNetworkNames = {
  0: ['Manhattan'],
  1: ['Avalanche', 'Mainnet'],
  2: ['Cascade'],
  3: ['Denali'],
...
export const NetworkNameToNetworkID = {
  Manhattan: 0,
  Avalanche: 1,
  Mainnet: 1,
  Cascade: 2,
...
export class Defaults {
  static network: Map<number, NetworkType> = new Map([
    [
      0,
      {
